  ...
  function mapProps(componentConstructor) {
    ...
    Object.keys(propOptionMap).forEach(function (propName) {
      ...
      defineWatches[defaultName] = {
        handler: function handler(v) {
          ...
          var hasDefault = props2 && (defaultName in props2 || kebabCase__default["default"](defaultName) in props2);
      ...
      defineWatches[propName] = {
        handler: function handler(v) {
          ...
          if (props2 && (propName in props2 || kebabCase__default["default"](propName) in props2)) {
            this.$data[dataName] = v;
          }
        },
        immediate: true
    ...
    return vue.defineComponent({
      ...
      render: function render() {
        ...
        return vue.h(componentConstructor, _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.$props), propMap), attrs), this._listeners), handlerMap), {}, {
          ref: "component"
        }), this.$slots);
      }
    });
