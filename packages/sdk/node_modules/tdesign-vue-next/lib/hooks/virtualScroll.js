...
var useVirtualScroll = function useVirtualScroll(_ref) {
  ...
  var calculateScrollY = function calculateScrollY() {
    ...
    for (var _i = index - 1; _i >= state.visibleData[0].$index; _i--) {
      ...
      state.cachedScrollY[_i] = _scrollY;
    }
    ...
    if (state.cachedScrollY[0] > 0) {
      ...
      for (var _i2 = 0; _i2 < length; _i2++) {
        state.cachedScrollY[_i2] -= distance;
      }
    ...
    if (last === data.value.length) {
      ...
      for (var _i3 = last - 1; _i3 >= start; _i3--) {
        if (_i3 === last - 1) {
          state.cachedScrollY[_i3] = scrollHeight.value - state.cachedHeight[_i3];
        } else {
          state.cachedScrollY[_i3] = state.cachedScrollY[_i3 + 1] - state.cachedHeight[_i3];
        }
      }
    }
  };
