...
var _Popup = vue.defineComponent({
  ...
  computed: {
    overlayClasses: function overlayClasses() {
      ...
      var base = ["".concat(name, "__content"), (_ref = {}, _defineProperty__default["default"](_ref, "".concat(name, "__content--arrow"), this.showArrow), _defineProperty__default["default"](_ref, utils_classnames["default"].STATUS.disabled, this.disabled), _ref)];
    ...
    visible: function visible(val) {
      ...
      if (val) {
        ...
        if (!this.hasDocumentEvent && (this.hasTrigger["context-menu"] || this.hasTrigger.click)) {
          utils_dom.on(document, "mousedown", this.handleDocumentClick);
          this.hasDocumentEvent = true;
        }

        if (this.referenceElm && this.hasTrigger.focus) {
          utils_dom.once(this.referenceElm, "keydown", function (ev) {
            if (ev.code === "Escape") {
              _this2.handleClose({
                trigger: "keydown-esc"
              });
        ...
        utils_dom.off(document, "mousedown", this.handleDocumentClick);
  ...
  mounted: function mounted() {
    ...
    if (this.hasTrigger.click) {
      offEvents.push(utils_dom.on(reference, "click", function (e) {
    ...
    if (this.hasTrigger.hover) {
      offEvents.push(utils_dom.on(reference, "mouseenter", function () {
        return _this3.handleOpen({
          trigger: "trigger-element-hover"
        });
      }));
      offEvents.push(utils_dom.on(reference, "mouseleave", function () {
        return _this3.handleClose({
          trigger: "trigger-element-hover"
        });
      }));
      offEvents.push(utils_dom.on(popperElm, "mouseenter", function () {
        return _this3.handleOpen({
          trigger: "trigger-element-hover"
        }, true);
      }));
      offEvents.push(utils_dom.on(popperElm, "mouseleave", function (ev) {
    ...
    if (this.hasTrigger.focus) {
      if (reference.querySelector("input,textarea")) {
        offEvents.push(utils_dom.on(reference, "focusin", function () {
          return _this3.handleOpen({
            trigger: "trigger-element-focus"
          });
        }));
        offEvents.push(utils_dom.on(reference, "focusout", function () {
          return _this3.handleClose({
            trigger: "trigger-element-blur"
          });
        }));
      } else {
        offEvents.push(utils_dom.on(reference, "mousedown", function () {
          return _this3.handleOpen({
            trigger: "trigger-element-click"
          });
        }));
        offEvents.push(utils_dom.on(reference, "mouseup", function () {
          return _this3.handleClose({
            trigger: "trigger-element-click"
          });
        }));
    ...
    if (this.hasTrigger["context-menu"]) {
      ...
      offEvents.push(utils_dom.on(reference, "mousedown", function (e) {
  ...
  methods: {
    createPopper: function createPopper() {
      ...
      var popperElm = this.$refs.popper;
      var overlayContainer = utils_dom.getAttach(this.attach);
      ...
      this.popper = core.createPopper(this.referenceElm, popperElm, {
        placement: placement,
    ...
    setOverlayStyle: function setOverlayStyle(styles) {
      ...
      if (_typeof__default["default"](styles) === "object" && refOverlayElm) {
        utils_setStyle["default"](refOverlayElm, styles);
      }
    },
    ...
    emitPopVisible: function emitPopVisible(val, context) {
      ...
      this.$nextTick(function () {
        utils_event.emitEvent(_this7, "visible-change", val, context);
      });
    },
    ...
    return vue.createVNode("div", {
      ...
      "default": function _default() {
        return [vue.withDirectives(vue.createVNode("div", {
          ...
          "ref": "overlay"
        }, [utils_renderTnode.renderTNodeJSX(_this8, "content"), _this8.showArrow && vue.createVNode("div", {
          "class": "".concat(name, "__arrow")
        }, null)])]), [[vue.vShow, !_this8.disabled && _this8.visible]])];
      }
    }), utils_renderTnode.renderContent(this, "default", "triggerElement")]);
  }
});
