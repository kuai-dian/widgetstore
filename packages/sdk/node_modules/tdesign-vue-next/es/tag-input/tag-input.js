...
import { defineComponent, ref, computed, nextTick, createVNode, mergeProps } from 'vue';
...
var _TagInput = defineComponent({
  ...
  setup: function setup(props2, context) {
    var root = ref(null);
    var inputValueRef = ref();

    var _useHover = useHover(props2),
        isHoverRef = _useHover.isHoverRef,
        addHover = _useHover.addHover,
        cancelHover = _useHover.cancelHover;

    var scrollFunctions = useTagScroll(props2, root);

    var _useTagList = useTagList(props2, context),
    ...
    var classes = computed(function () {
      return [NAME_CLASS, _defineProperty({}, BREAK_LINE_CLASS, props2.excessTagsDisplayType === "break-line")];
    });
  ...
  methods: {
    renderLabel: function renderLabel() {
      ...
      var list = displayNode !== null && displayNode !== void 0 ? displayNode : newList === null || newList === void 0 ? void 0 : newList.map(function (item, index) {
        var tagContent = renderTNodeJSX(_this, "tag", {
          params: {
            value: item
          }
        });
      ...
      if (newList.length !== this.tagValue.length) {
        ...
        var more = renderTNodeJSX(this, "collapsedItems", {
          params: {
            value: this.tagValue,
        ...
        list.push(more !== null && more !== void 0 ? more : createVNode(Tag, null, {
          "default": function _default() {
            return ["+", len];
          }
        }));
    ...
    renderSuffixIcon: function renderSuffixIcon() {
      var suffixIcon = renderTNodeJSX(this, "suffixIcon");
