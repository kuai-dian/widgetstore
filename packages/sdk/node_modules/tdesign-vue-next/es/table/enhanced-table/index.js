...
var _EnhancedTable = defineComponent({
  ...
  render: function render() {
    ...
    var primaryTableProps2 = _objectSpread(_objectSpread(_objectSpread({}, $props), this.$attrs), {}, {
      data: this.dataSource,
      columns: this.columnsSource
    }, listeners);

    return createVNode(_PrimaryTable, primaryTableProps2, _isSlot($slots) ? $slots : {
