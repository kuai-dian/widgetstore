...
var SorterButton = defineComponent(_objectSpread(_objectSpread({}, mixins(getConfigReceiverMixins("table"))), {}, {
  ...
  methods: {
    getSortIcon: function getSortIcon(direction, className) {
      var icon = isFunction(this.global.sortIcon) ? this.global.sortIcon(h) : createVNode(ChevronDownIcon, {
        "size": "16px"
      }, null);
      var style = {
        left: "0px"
  ...
  render: function render() {
    ...
    }, buttonProps), [tips ? createVNode(Tooltip, {
