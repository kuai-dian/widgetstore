...
var _List = defineComponent({
  ...
  computed: {
    ...
    loadingClass: function loadingClass() {
      return typeof this.asyncLoading === "string" && ["loading", "load-more"].includes(this.asyncLoading) ? "".concat(name, "__load ").concat(name, "__load--").concat(this.asyncLoading) : "".concat(name, "__load");
    }
  },
  methods: {
    renderLoading: function renderLoading() {
      if (this.asyncLoading && typeof this.asyncLoading === "string") {
        if (this.asyncLoading === LOADING) {
          return createVNode("div", null, [createVNode(Loading, null, null), createVNode("span", null, ["\u6B63\u5728\u52A0\u8F7D\u4E2D\uFF0C\u8BF7\u7A0D\u7B49"])]);
        }

        if (this.asyncLoading === LOAD_MORE) {
          return createVNode("span", null, ["\u70B9\u51FB\u52A0\u8F7D\u66F4\u591A"]);
        }
      }
    ...
    renderContent: function renderContent() {
      ...
      }, [renderTNodeJSX(this, "default")]), propsFooterContent && createVNode("div", {
