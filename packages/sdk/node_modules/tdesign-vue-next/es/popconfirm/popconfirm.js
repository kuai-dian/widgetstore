...
var _Popconfirm = defineComponent(_objectSpread(_objectSpread({}, mixins(ActionMixin, getConfigReceiverMixins("popconfirm"))), {}, {
  name: "TPopconfirm",
  props: props,
  ...
  methods: {
    ...
    renderIcon: function renderIcon() {
      ...
      return renderTNodeJSXDefault(this, "icon", createVNode(Icon, {
        "class": this.iconCls
      }, null));
    },
  ...
  render: function render() {
    ...
    return createVNode(Popup, mergeProps({
      ...
      content: function content() {
        ...
        }, [_this.renderIcon(), createVNode("div", {
          "class": "".concat(name, "__inner")
        }, [renderTNodeJSX(_this, "content")])]), Boolean(cancelBtn || confirmBtn) && createVNode("div", {
