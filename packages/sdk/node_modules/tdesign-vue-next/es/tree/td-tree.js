...
import { isVNode, defineComponent, TransitionGroup, createVNode, resolveComponent } from 'vue';
...
var _TdTree = defineComponent(_objectSpread(_objectSpread({}, mixins(getConfigReceiverMixins("tree"))), {}, {
  name: "TTree",
  components: {
