...
var _InputNumber = defineComponent({
  ...
  computed: {
    ...
    reduceClasses: function reduceClasses() {
      return ["".concat(name, "__decrease"), _defineProperty({}, ClASSNAMES.STATUS.disabled, this.disabledReduce)];
    },
    ...
    addClasses: function addClasses() {
      return ["".concat(name, "__increase"), _defineProperty({}, ClASSNAMES.STATUS.disabled, this.disabledAdd)];
    },
    ...
    cmptWrapClasses: function cmptWrapClasses() {
      ...
      return ["t-input-number", ClASSNAMES.SIZE[this.size], (_ref3 = {}, _defineProperty(_ref3, ClASSNAMES.STATUS.disabled, this.disabled), _defineProperty(_ref3, "t-is-controls-right", this.theme === "column"), _defineProperty(_ref3, "t-input-number--normal", this.theme === "normal"), _ref3)];
    },
    inputWrapProps: function inputWrapProps() {
      return ["t-input", _defineProperty({
        "t-is-error": this.isError
      }, "".concat(prefix, "-align-").concat(this.align), this.align)];
    },
    inputClasses: function inputClasses() {
      var _ref5;

      return ["t-input__inner", (_ref5 = {}, _defineProperty(_ref5, ClASSNAMES.STATUS.disabled, this.disabled), _defineProperty(_ref5, "".concat(name, "-text-align"), this.theme === "row"), _ref5)];
    },
  ...
  render: function render() {
    ...
    }, this.inputAttrs, this.inputEvents), null)]), this.theme !== "normal" && createVNode(resolveComponent("t-button"), mergeProps({
