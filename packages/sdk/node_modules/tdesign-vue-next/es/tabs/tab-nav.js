...
import { defineComponent, Transition, createVNode, resolveComponent } from 'vue';
...
var TTabNav = defineComponent(_objectSpread(_objectSpread({
  ...
  methods: {
    ...
    caculateNavBarStyle: function caculateNavBarStyle() {
      ...
      var getNavBarStyle = function getNavBarStyle() {
        ...
        for (; i < _this7.navs.length; i++) {
          ...
          offset += ((_this7$navs$i = _this7.navs[i]) === null || _this7$navs$i === void 0 ? void 0 : (_this7$navs$i$el = _this7$navs$i.el) === null || _this7$navs$i$el === void 0 ? void 0 : _this7$navs$i$el["client".concat(firstUpperCase(sizePropName))]) || 0;
        }

        if (!_this7.navs[i]) return {};
        return _ref5 = {}, _defineProperty(_ref5, offsetPropName, "".concat(offset, "px")), _defineProperty(_ref5, sizePropName, "".concat(((_this7$navs$i$el2 = _this7.navs[i].el) === null || _this7$navs$i$el2 === void 0 ? void 0 : _this7$navs$i$el2["client".concat(firstUpperCase(sizePropName))]) || 0, "px")), _ref5;
      };
    ...
    resetScrollPosition: debounce(function () {
    ...
    renderArrows: function renderArrows() {
      ...
      return [createVNode("div", {
        ...
        "default": function _default() {
          return [_this11.canToLeft ? createVNode("div", {
            "ref": "leftIcon",
            "class": _this11.leftIconClass,
            "onClick": _this11.handleScrollToLeft
          }, [createVNode(ChevronLeftIcon, null, null)]) : null];
        }
      })]), createVNode("div", {
        ...
        "default": function _default() {
          return [_this11.canToRight ? createVNode("div", {
            "ref": "rightIcon",
            "class": _this11.rightIconClass,
            "onClick": _this11.handleScrollToRight
          }, [createVNode(ChevronRightIcon, null, null)]) : null];
        }
      }), this.theme === "card" && this.addable ? createVNode("div", {
        "class": this.addIconClass,
        "onClick": this.handleAddTab
      }, [createVNode(AddIcon, null, null)]) : null])];
    },
