...
var Dragger = defineComponent({
  ...
  methods: {
    ...
    renderDefaultDragElement: function renderDefaultDragElement() {
      ...
      }, ["\u70B9\u51FB\u4E0A\u4F20"]), createVNode("span", null, ["\xA0\xA0/\xA0\xA0\u62D6\u62FD\u5230\u6B64\u533A\u57DF"])]);

      var activeElement = createVNode("div", null, ["\u91CA\u653E\u9F20\u6807"]);
    ...
    renderImage: function renderImage() {
      ...
      }, [this.imageUrl && createVNode("img", {
        "src": this.imageUrl
      }, null)]);
    },
    renderUploading: function renderUploading() {
      if (this.loadingFile.status === "fail") {
        return createVNode(ErrorCircleFilledIcon, null, null);
      }
    ...
    renderProgress: function renderProgress() {
      ...
      }, [this.isImage && this.renderImage(), createVNode("div", {
      ...
      }, [abridgeName(this.inputName)]), this.loadingFile && this.renderUploading(), !this.loadingFile && !!this.file && createVNode(CheckCircleFilledIcon, null, null)]), createVNode("small", {
        "class": "".concat(prefix, "-size-s")
      }, ["\u6587\u4EF6\u5927\u5C0F\uFF1A", returnFileSize(this.size)]), createVNode("small", {
        "class": "".concat(prefix, "-size-s")
      }, ["\u4E0A\u4F20\u65E5\u671F\uFF1A", getCurrentDate()]), createVNode("div", {
        "class": "".concat(UPLOAD_NAME, "__dragger-btns")
      }, [["progress", "waiting"].includes((_this$loadingFile2 = this.loadingFile) === null || _this$loadingFile2 === void 0 ? void 0 : _this$loadingFile2.status) && createVNode(Button, {
        "theme": "primary",
        "variant": "text",
      ...
      }), !this.autoUpload && ((_this$loadingFile3 = this.loadingFile) === null || _this$loadingFile3 === void 0 ? void 0 : _this$loadingFile3.status) === "waiting" && createVNode(Button, {
        "theme": "primary",
        "variant": "text",
      ...
      })]), this.showResultOperate && createVNode("div", {
        "class": "".concat(UPLOAD_NAME, "__dragger-btns")
