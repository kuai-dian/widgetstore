...
var _Upload = defineComponent(_objectSpread(_objectSpread({}, mixins(getConfigReceiverMixins("upload"))), {}, {
  name: "TUpload",
  components: {
    TButton: Button,
    Dragger: Dragger,
  ...
  methods: {
    ...
    uploadFiles: function uploadFiles(files) {
      ...
      tmpFiles.forEach(function (fileRaw) {
        ...
        _this.handleBeforeUpload(file).then(function (canUpload) {
          ...
          _this.toUploadFiles = _toConsumableArray(new Set(newFiles));
    ...
    renderSingleDisplay: function renderSingleDisplay(triggerElement) {
      ...
      return createVNode(resolveComponent("single-file"), {
        ...
        "default": function _default() {
          ...
          }, [triggerElement, !!(_this9.theme === "file-input" && (_this$files2 = _this9.files) !== null && _this$files2 !== void 0 && _this$files2.length) && createVNode(Button, {
            "theme": "primary",
            "variant": "text",
    ...
    renderDraggerTrigger: function renderDraggerTrigger() {
      ...
      return createVNode(resolveComponent("dragger"), {
        "showUploadProgress": this.showUploadProgress,
    ...
    renderCustom: function renderCustom(triggerElement) {
      return this.draggable ? this.renderDraggerTrigger() : createVNode("div", {
  ...
  render: function render() {
    ...
    return createVNode("div", {
      "class": "".concat(name)
    }, [this.renderInput(), this.showCustomDisplay && this.renderCustom(triggerElement), this.showSingleDisplay && this.renderSingleDisplay(triggerElement), this.singleDraggable && this.renderDraggerTrigger(), this.showImgCard && createVNode(ImageCard, {
      "files": this.files,
      "multiple": this.multiple,
      ...
      "disabled": this.disabled
    }, null), this.showUploadList && createVNode(resolveComponent("flow-list"), {
      "files": this.files,
      "placeholder": this.placeholder,
      "autoUpload": this.autoUpload,
      "toUploadFiles": this.toUploadFiles,
    ...
    }), this.showImgDialog && createVNode(Dialog, {
    ...
    }), !this.errorMsg && this.showTips && createVNode("small", {
      "class": this.tipsClasses
    }, [this.tips]), this.showErrorMsg && createVNode("small", {
