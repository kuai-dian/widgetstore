  ...
  methods: {
    ...
    renderResult: function renderResult() {
      ...
      if (this.file && this.file.name && !this.loadingFile) {
        return createVNode(CheckCircleFilledIcon, null, null);
      }
    ...
    renderFilePreviewAsText: function renderFilePreviewAsText() {
      ...
      return createVNode("div", {
        "class": "".concat(UPLOAD_NAME, "__single-display-text ").concat(UPLOAD_NAME, "__display-text--margin")
      }, [createVNode("span", {
        "class": "".concat(UPLOAD_NAME, "__single-name")
      }, [this.inputName]), this.showProgress ? this.renderProgress() : createVNode(CloseCircleFilledIcon, {
