...
import { isVNode, defineComponent, nextTick, createVNode, resolveComponent } from 'vue';
import dayjs from 'dayjs';
import { c as customParseFormat, P as PanelCol } from '../../_chunks/dep-ff8379e8.js';
import mixins from '../../utils/mixins.js';
import getConfigReceiverMixins from '../../config-provider/config-receiver.js';
import { COMPONENT_NAME, EPickerCols } from '../constant.js';
...
var name = "".concat(COMPONENT_NAME, "__panel");
dayjs.extend(customParseFormat);
var PickerPanel = defineComponent(_objectSpread(_objectSpread({}, mixins(getConfigReceiverMixins("timePicker"))), {}, {
  name: name,
  components: {
    PanelCol: PanelCol,
    TButton: TButton
