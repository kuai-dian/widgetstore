...
import { defineComponent, ref, onMounted, onBeforeUnmount, inject, createVNode, resolveComponent, mergeProps } from 'vue';
...
var TableRow = defineComponent({
  ...
  props: TableRowProps,
  emits: ["rowMounted", "getRowHeight"].concat(_toConsumableArray(Object.keys(eventsName).map(function (key) {
    return eventsName[key];
  }))),
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var tr = ref(null);
    var isInit = ref(props.index === 0);
    ...
    onMounted(function () {
      ...
      if (scrollType === "virtual") {
        ...
        var scrollBody = inject("scrollBody");

        if (rowHeight === 0) {
          var rowHeightRef = inject("rowHeightRef");
  ...
  methods: {
    renderRow: function renderRow() {
      ...
      columns.forEach(function (column, index) {
        ...
        rowBody.push(createVNode(resolveComponent("table-cell"), mergeProps({
  ...
  render: function render() {
    ...
    Object.keys(eventsName).forEach(function (event) {
      ...
      on[getPropsApiByEvent(event)] = function (e) {
