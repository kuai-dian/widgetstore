...
var _PrimaryTable = defineComponent({
  ...
  emits: ["change", "page-change"].concat(_toConsumableArray(EVENT_NAME_WITH_KEBAB)),
  computed: {
  ...
  methods: {
    renderLastFullRow: function renderLastFullRow() {
      ...
      return createVNode("div", null, [nodes[0], nodes[1]]);
    }
  },
  render: function render() {
    ...
    var listeners = _objectSpread({
      onPageChange: function onPageChange(pageInfo, newDataSource) {
    ...
    if (this.expandOnRowClick) {
      listeners.onRowClick = function (params) {
        _this.handleExpandChange(params.row);
      };
    }

    var baseTableProps2 = _objectSpread(_objectSpread({}, $props), {}, {
      columns: rehandleColumns,
      provider: {
        renderExpandedRow: ((_this$expandedRow = this.expandedRow) !== null && _this$expandedRow !== void 0 ? _this$expandedRow : this.$slots.expandedRow) ? this.renderExpandedRow : void 0,
    ...
    return createVNode("div", {
      "style": "width: 100%"
    }, [createVNode(resolveComponent("simple-table"), baseTableProps2, _isSlot($slots) ? $slots : {
