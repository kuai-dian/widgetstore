...
var _Switch = defineComponent({
  ...
  computed: {
    classes: function classes() {
      ...
      return ["".concat(name), ClASSNAMES.SIZE[this.size], (_ref = {}, _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.disabled), _defineProperty(_ref, ClASSNAMES.STATUS.loading, this.loading), _defineProperty(_ref, ClASSNAMES.STATUS.checked, this.value === this.activeValue), _ref)];
    },
    nodeClasses: function nodeClasses() {
      var _ref2;

      return ["".concat(name, "__handle"), (_ref2 = {}, _defineProperty(_ref2, ClASSNAMES.STATUS.disabled, this.disabled), _defineProperty(_ref2, ClASSNAMES.STATUS.loading, this.loading), _ref2)];
    },
    contentClasses: function contentClasses() {
      return ["".concat(name, "__content"), ClASSNAMES.SIZE[this.size], _defineProperty({}, ClASSNAMES.STATUS.disabled, this.disabled)];
    },
