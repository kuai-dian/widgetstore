...
import { isVNode, defineComponent, nextTick, createVNode, resolveComponent, withDirectives, vShow } from 'vue';
...
var _Select = defineComponent(_objectSpread(_objectSpread({}, mixins(getConfigReceiverMixins("select"))), {}, {
  name: "TSelect",
  components: {
  ...
  computed: {
    classes: function classes() {
      ...
      return ["".concat(name), (_ref = {}, _defineProperty(_ref, ClASSNAMES.STATUS.disabled, this.disabled), _defineProperty(_ref, ClASSNAMES.STATUS.active, this.visible), _defineProperty(_ref, ClASSNAMES.SIZE[this.size], this.size), _defineProperty(_ref, "".concat(prefix, "-has-prefix"), this.$slots.prefixIcon), _defineProperty(_ref, "".concat(prefix, "-no-border"), !this.bordered), _ref)];
    },
    ...
    showPlaceholder: function showPlaceholder() {
      if (!this.showFilter && (!this.multiple && !this.selectedSingle || !this.multiple && _typeof(this.value) === "object" && !this.selectedSingle || Array.isArray(this.value) && !this.value.length || this.value === null || this.value === void 0 || this.value === "")) {
        return true;
      }
  ...
  methods: {
    ...
    getOptions: function getOptions(option) {
      ...
      var tmp = this.realOptions.filter(function (item) {
        return get(item, _this8.realValue) === option.value;
      });
    ...
    renderGroupOptions: function renderGroupOptions(options) {
      ...
      return createVNode("ul", null, [options.map(function (groupList) {
        var _slot;
    ...
    renderOptions: function renderOptions(options) {
      ...
      return createVNode("ul", null, [options.map(function (item, index) {
        return createVNode(resolveComponent("t-option"), {
          "value": get(item, _this14.realValue),
          "label": get(item, _this14.realLabel),
          "content": item.content,
          "disabled": item.disabled || _this14.multiLimitDisabled(get(item, _this14.realValue)),
          "key": index
        }, null);
      })]);
    },
    ...
    initHoverindex: function initHoverindex() {
      ...
      if (!this.multiple && (typeof this.value === "string" || typeof this.value === "number")) {
        var targetIndex = Object.keys(this.hoverOptions).filter(function (i) {
          return get(_this15.hoverOptions[i], _this15.realValue) === _this15.value;
        });
        ...
        this.value.some(function (item) {
          var targetIndex = Object.keys(_this15.hoverOptions).filter(function (i) {
            return _typeof(item) === "object" && get(_this15.hoverOptions[i], _this15.realValue) === get(item, _this15.realValue) || get(_this15.hoverOptions[i], _this15.realValue) === item;
          });
    ...
    var slots = {
      content: function content() {
        return createVNode("div", {
          "className": "".concat(prefix, "-select__dropdown-inner")
        }, [renderTNodeJSX(_this16, "panelTopContent"), withDirectives(createVNode("ul", {
        ...
        }, null)]), [[vShow, showCreateOption]]), loading && createVNode("div", {
          "class": tipsClass
        }, [loadingTextSlot || loadingText]), !loading && !displayOptions.length && !showCreateOption && createVNode("li", {
          "class": emptyClass
        }, [emptySlot]), !hasOptions && displayOptions.length && !loading ? _this16.renderDataWithOptions() : createVNode("ul", {
          "class": "".concat(prefix, "-select__groups")
        }, [children]), renderTNodeJSX(_this16, "panelBottomContent")]);
      }
    };
    return createVNode("div", {
      "ref": "select",
      ...
      "default": function _default() {
        return [createVNode("div", {
        ...
        }, [prefixIconSlot[0]]), showPlaceholder && createVNode("span", {
          "class": "".concat(name, "__placeholder")
        }, [" ", placeholderText]), _this16.valueDisplay || _this16.$slots.valueDisplay ? renderTNodeJSX(_this16, "valueDisplay", {
          params: {
          ...
          }, _isSlot(_slot2 = get(item, realLabel)) ? _slot2 : {
            "default": function _default() {
              return [_slot2];
            }
          }), [[vShow, _this16.minCollapsedNum <= 0 || index < _this16.minCollapsedNum]]);
        }), _this16.collapsedItems || _this16.$slots.collapsedItems ? renderTNodeJSX(_this16, "collapsedItems", {
          params: {
            value: selectedMultiple,
        ...
        }), [[vShow, _this16.minCollapsedNum > 0 && selectedMultiple.length > _this16.minCollapsedNum]]), !multiple && !showPlaceholder && !showFilter && createVNode("span", {
          "title": selectedSingle,
          "class": "".concat(name, "__single")
        }, [selectedSingle]), showFilter && createVNode(resolveComponent("t-input"), {
          "ref": "input",
        ...
        }, null), _this16.showArrow && !_this16.showLoading && createVNode(FakeArrow, {
          "overlayClassName": "".concat(name, "__right-icon"),
          "isActive": _this16.visible && !_this16.disabled
        }, null), _this16.showClose && !_this16.showLoading && _this16.getCloseIcon(), _this16.showLoading && createVNode(Loading, {
