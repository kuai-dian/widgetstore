...
import { c as commonjsGlobal } from './dep-b66bfe36.js';
import { panelColProps } from '../time-picker/panel/props.js';
import { EPickerCols, COMPONENT_NAME } from '../time-picker/constant.js';
...
var PanelCol = defineComponent({
  ...
  computed: {
    ...
    timeItemMargin: function timeItemMargin() {
      ...
      var maskDom = (_this$$el = this.$el) === null || _this$$el === void 0 ? void 0 : (_this$$el$querySelect = _this$$el.querySelector) === null || _this$$el$querySelect === void 0 ? void 0 : _this$$el$querySelect.call(_this$$el, ".".concat(COMPONENT_NAME, "__panel-body-active-mask > div"));
  ...
  methods: {
    ...
    generateColRows: function generateColRows(col) {
      ...
      return this.generateColTime(col).map(function (el) {
        ...
        var classNames = ["".concat(COMPONENT_NAME, "__panel-body-scroll-item"), (_ref = {}, _defineProperty(_ref, "".concat(prefix, "-is-disabled"), !_this3.timeItemCanUsed(col, el)), _defineProperty(_ref, "".concat(prefix, "-is-current"), isCurrent), _ref)];
    ...
    renderScroller: function renderScroller(col) {
      ...
      return createVNode("ul", {
        "class": "".concat(COMPONENT_NAME, "__panel-body-scroll"),
    ...
    renderActiveMask: function renderActiveMask() {
      return createVNode("div", {
        "class": "".concat(COMPONENT_NAME, "__panel-body-active-mask")
