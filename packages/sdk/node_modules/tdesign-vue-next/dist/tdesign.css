...
.t-popup--animation-leave-active {
  -webkit-transition: opacity 0.2s cubic-bezier(0, 0, 0.15, 1), visibility 0.2s cubic-bezier(0.82, 0, 1, 0.9), max-height 0.2s cubic-bezier(0.38, 0, 0.24, 1);
  transition: opacity 0.2s cubic-bezier(0, 0, 0.15, 1), visibility 0.2s cubic-bezier(0.82, 0, 1, 0.9), max-height 0.2s cubic-bezier(0.38, 0, 0.24, 1);
}
...
.t-input-number .t-input__inner.t-is-disabled {
  color: var(--td-text-color-disabled);
}
.t-input-number .t-input__inner.t-is-disabled::-webkit-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-input-number .t-input__inner.t-is-disabled::-moz-placeholder {
  color: var(--td-text-color-disabled);
}
.t-input-number .t-input__inner.t-is-disabled:-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-input-number .t-input__inner.t-is-disabled::-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-input-number .t-input__inner.t-is-disabled::placeholder {
  color: var(--td-text-color-disabled);
}
...
.t-input-number__decrease + .t-input {
  margin-left: 4px;
}
...
.t-tag-input .t-tag {
  margin-right: 4px;
  -webkit-animation: t-zoom-out 0.1s ease-in-out;
          animation: t-zoom-out 0.1s ease-in-out;
}
.t-tag-input.t-input {
  padding-left: 4px;
  overflow: hidden;
}
.t-tag-input .t-input__inner {
  min-width: 80px;
  width: auto;
}
...
.t-tag-input--break-line.t-input .t-tag-input__suffix-clear {
  position: absolute;
  right: 8px;
  bottom: 8px;
}
...
/** 光标动画 */
@-webkit-keyframes t-tag-cursor-show {
  0% {
    opacity: 0;
  }
  100% {
...
.t-tag-input__cursor {
  ...
  margin-right: 4px;
  opacity: 1;
  -webkit-animation: t-tag-cursor-show 0.8s ease infinite;
          animation: t-tag-cursor-show 0.8s ease infinite;
}
